...
straddles %>% filter(ticker %in% c("SPY", "QQQ", "IWM")) %>% ggplot(aes(x=-profit_pct*100, fill=ticker)) + geom_boxplot(color="black", alpha=0.5) + theme(legend.position = "right") + xlab("Short Straddle Profit")
